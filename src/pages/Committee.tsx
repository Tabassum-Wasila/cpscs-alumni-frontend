...
const Committee = () => {
  ...
  const renderCommitteeGrid = (members: CommitteeMemberType[]) => {
    ...
    return <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mb-16">
      ...
      <div className="flex-grow pt-40 lg:pt-24 pb-16 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h1 className="font-bold text-cpscs-blue mb-4 text-3xl">Committees of CPSCS Alumni Association</h1>
          </div>
