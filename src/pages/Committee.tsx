...
const Committee = () => {
  ...
  const renderCommitteeGrid = (members: CommitteeMemberType[]) => <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 mb-16">
      {members.map(member => <CommitteeMember key={member.sequence} member={member} onClick={handleMemberClick} />)}
    </div>;
        ...
        <div className="container mx-auto px-4">
          ...
          <Tabs defaultValue="executive" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-8 bg-white/70 backdrop-blur-sm">
              <TabsTrigger value="executive" className="text-lg font-semibold data-[state=active]:bg-cpscs-blue data-[state=active]:text-white">
                Executive Committee
              </TabsTrigger>
              <TabsTrigger value="advisor" className="text-lg font-semibold data-[state=active]:bg-cpscs-blue data-[state=active]:text-white">
                Advisor Council
              </TabsTrigger>
            </TabsList>
          ...
          <div className="text-center bg-white/50 backdrop-blur-sm rounded-2xl p-12 border border-white/20">
            ...
            <Button onClick={handlePreviousCommitteeClick} size="lg" className="bg-cpscs-blue hover:bg-cpscs-blue/90 text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
