...
import { Heart, Building2, Users, Star, Trophy, Loader2 } from 'lucide-react';
...
const Sponsors = () => {
  ...
  const filteredSponsors = useMemo(() => {
    ...
    return filtered;
  }, [activeTab, filters, sponsorsData]);
        ...
        <div className="container mx-auto px-4">
          ...
          {sponsorsLoading && (
            <div className="flex flex-col items-center justify-center py-20">
              <Loader2 className="w-12 h-12 text-cpscs-blue animate-spin mb-4" />
          ...
          {sponsorsError && (
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <h2 className="text-2xl font-bold text-gray-800 mb-2">Unable to Load Sponsors</h2>
              <p className="text-gray-600 max-w-md">
                We're having trouble loading our sponsors data. Please try again later.
              </p>
            </div>
          )}

          {/* Main Content - Only show when data is loaded */}
          {sponsorsData && !sponsorsLoading && (
            <>
              {/* Hero Section */}
